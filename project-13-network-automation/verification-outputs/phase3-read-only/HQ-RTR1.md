# HQ-RTR1 Read-Only Baseline

- Host: 10.0.255.1
- Platform: cisco_ios
- Role: core_router
- Collected UTC: 2026-06-19T05:58:45.570512+00:00
...
WAN-RTR1.lab.local
                 Eth 0/2           130               R    Linux Uni Eth 0/1
HQ-DSW1.lab.local
                 Eth 0/0           145             R S I  Linux Uni Eth 0/0
BR-RTR1.lab.local
                 Eth 0/1           160               R    Linux Uni Eth 0/1
...
Ethernet0/0.100        10.1.100.1      YES NVRAM  up                    up
Ethernet0/0.200        10.1.200.1      YES NVRAM  up                    up
Ethernet0/0.300        10.1.44.1       YES NVRAM  up                    up
Ethernet0/0.400        10.1.40.1       YES NVRAM  administratively down down
Ethernet0/0.999        10.1.99.1       YES NVRAM  up                    up
Ethernet0/1            10.0.0.1        YES NVRAM  up                    up
Ethernet0/2            10.0.0.5        YES NVRAM  up                    up
Ethernet0/3            10.0.0.13       YES NVRAM  up                    up
Loopback0              10.0.255.1      YES NVRAM  up                    up
Loopback99             10.255.99.99    YES NVRAM  up                    up
Tunnel0                10.0.100.1      YES NVRAM  up                    up
```
...
```text
05:58:59.643 UTC Fri Jun 19 2026
```
...
10.0.255.3        0   FULL/  -        00:00:39    10.0.0.6        Ethernet0/2
10.0.255.2        0   FULL/  -        00:00:39    10.0.0.2        Ethernet0/1
10.0.255.2        0   FULL/  -        00:00:38    10.0.100.2      Tunnel0
```
...
HQ-DSW1.lab.local   Et0/0          120        B,R             Et0/0
BR-RTR1.lab.local   Et0/1          120        R               Et0/1
WAN-RTR1.lab.local  Et0/2          120        R               Et0/1
