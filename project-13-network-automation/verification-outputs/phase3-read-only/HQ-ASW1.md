# HQ-ASW1 Read-Only Baseline

- Host: 10.1.99.13
- Platform: cisco_ios
- Role: access_switch
- Collected UTC: 2026-06-19T05:59:57.747769+00:00
...
HQ-DSW2.lab.local
                 Eth 0/1           138             R S I  Linux Uni Eth 0/1
HQ-DSW1.lab.local
                 Eth 0/0           149             R S I  Linux Uni Eth 0/1
...
Vlan999                10.1.99.13      YES NVRAM  up                    up
```
...
```text
06:00:11.949 UTC Fri Jun 19 2026
```
...
*~10.0.255.1      127.127.1.1      3    750   1024   377  2.000  -0.261  2.089
...
HQ-DSW1.lab.local   Et0/0          120        B,R             Et0/1
HQ-DSW2.lab.local   Et0/1          120        B,R             Et0/1
