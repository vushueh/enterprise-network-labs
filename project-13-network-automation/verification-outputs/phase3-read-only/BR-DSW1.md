# BR-DSW1 Read-Only Baseline

- Host: 10.2.99.2
- Platform: cisco_ios
- Role: branch_distribution_switch
- Collected UTC: 2026-06-19T06:00:22.173979+00:00
...
BR-ASW1.lab.local
                 Eth 0/1           130             R S I  Linux Uni Eth 0/0
BR-RTR1.lab.local
                 Eth 0/0           178               R    Linux Uni Eth 0/0
...
Vlan999                10.2.99.2       YES NVRAM  up                    up
```
...
```text
06:00:35.621 UTC Fri Jun 19 2026
```
...
*~10.0.255.1      127.127.1.1      3    718   1024   377  3.000   0.179  2.067
...
BR-ASW1.lab.local   Et0/1          120        B,R             Et0/0
BR-RTR1.lab.local   Et0/0          120        R               Et0/0
