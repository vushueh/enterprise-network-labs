# BR-ASW1 Read-Only Baseline

- Host: 10.2.99.3
- Platform: cisco_ios
- Role: branch_access_switch
- Collected UTC: 2026-06-19T06:00:38.675786+00:00
...
BR-DSW1.lab.local
                 Eth 0/0           172             R S I  Linux Uni Eth 0/1
...
Vlan999                10.2.99.3       YES NVRAM  up                    up
```
...
```text
06:00:42.149 UTC Fri Jun 19 2026
```
...
*~10.0.255.1      127.127.1.1      3    519   1024   377  5.000  -0.060  2.018
...
BR-DSW1.lab.local   Et0/0          120        B,R             Et0/1
