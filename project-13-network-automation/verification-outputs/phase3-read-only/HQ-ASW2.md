# HQ-ASW2 Read-Only Baseline

- Host: 10.1.99.14
- Platform: cisco_ios
- Role: access_switch
- Collected UTC: 2026-06-19T06:00:14.888565+00:00
...
HQ-DSW2.lab.local
                 Eth 0/1           121             R S I  Linux Uni Eth 0/2
HQ-DSW1.lab.local
                 Eth 0/0           149             R S I  Linux Uni Eth 0/2
...
Vlan999                10.1.99.14      YES NVRAM  up                    up
```
...
```text
06:00:19.222 UTC Fri Jun 19 2026
```
...
*~10.0.255.1      127.127.1.1      3    582   1024   377  3.000   0.287  2.001
...
HQ-DSW2.lab.local   Et0/1          120        B,R             Et0/2
HQ-DSW1.lab.local   Et0/0          120        B,R             Et0/2
